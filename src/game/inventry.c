...
#define INVENTORY_LOOT_LEFT_SCROLLER_X 44
...
#define INVENTORY_LOOT_RIGHT_SCROLLER_X 422
...
void display_target_inventory(int a1, int a2, Inventory* inventory, int inventoryWindowType)
{
    ...
    if (inventoryWindowType == INVENTORY_WINDOW_TYPE_LOOT) {
        ...
        if (data != NULL) {
            buf_to_buf(data + 537 * 35 + 422, 64, 48 * inven_cur_disp, 537, windowBuffer + 537 * 35 + 422, 537);
